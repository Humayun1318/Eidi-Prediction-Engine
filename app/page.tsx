...
import AddRelativesModal from "./_components/AddRelativesModal";
      ...
      <div className="w-full max-w-[320px] sm:max-w-md z-10 flex flex-col items-center justify-center min-h-[90vh] sm:min-h-[80vh]">
        ...
        <div className="w-full bg-white/5 backdrop-blur border-2 border-purple-500/30 rounded-2xl p-5 sm:p-6 text-center hover:border-pink-400 transition-all mb-4">
          ...
          <button
            ...
            className="w-full py-4 sm:py-5 cursor-pointer bg-linear-to-r from-pink-500 to-purple-600 rounded-xl font-bold text-base sm:text-lg shadow-xl active:scale-95 transition-all flex items-center justify-center gap-2 border border-white/10"
          >
            <span className="text-xl ">➕</span>
            Add Relatives
            <span className="text-xl">🔥</span>
